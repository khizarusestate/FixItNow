...
export default function ReviewsSection() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 lg:grid-cols-4">
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-2xl border border-slate-200 bg-gray-200 p-6 text-slate-600 shadow-xl shadow-black/30">
                ...
                <button
                  ...
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-orange-600"
                >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-blue-900/60 px-4 backdrop-blur-sm">
