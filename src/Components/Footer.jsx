          ...
          <div>
            ...
            <div className="mt-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="flex h-8 items-center rounded-md border border-white/10 bg-white px-2.5"><span className="text-xs font-bold italic tracking-wide text-[#1434CB]">VISA</span></span>
                <span className="flex h-8 items-center rounded-md border border-white/10 bg-white px-2"><img src="/Assets/JazzCash.png" alt="JazzCash" className="max-h-6 w-auto object-contain" /></span>
                <span className="flex h-8 items-center rounded-md border border-white/10 bg-white px-2"><img src="/Assets/EasyPaisa.png" alt="Easypaisa" className="max-h-6 w-auto object-contain" /></span>
              </div>
            </div>
          </div>
        </div>
