  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-slate-500 flex items-center gap-1">
        ...
        Scroll to <strong className="text-slate-700">Book a Service</strong> on the home page
      </p>
    </div>
  );
}
      ...
      <div className="rounded-2xl border-2 border-slate-200 bg-white shadow-xl overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-100 bg-white px-3 py-2.5">
          ...
          <div className="flex items-center gap-1">
            <HighlightRing>
              <span className="relative z-10 flex h-9 w-9 items-center justify-center rounded-lg bg-orange-50 text-slate-800">
                <Menu size={20} />
              </span>
            </HighlightRing>
          </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-2 shadow-sm">
        <div className="flex items-center justify-end gap-2 mb-2 px-1">
          ...
          <HighlightRing label="My Bookings">
            <span className="relative z-10 inline-flex items-center gap-1 rounded-lg border-2 border-slate-200 px-2.5 py-1.5 text-xs font-medium text-slate-700">
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
          <div className="flex items-center justify-between">
            <p className="text-sm font-bold text-slate-900">Home Cleaning</p>
        ...
        <div className="mt-2 rounded-lg border border-blue-200 bg-blue-50 p-3">
          <div className="flex items-center justify-between">
            <p className="text-sm font-bold text-slate-900">Plumbing fix</p>
      ...
      <div className="relative flex w-full max-w-md max-h-[min(92vh,640px)] flex-col overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl shadow-orange-500/10 animate-scaleIn">
        ...
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 px-5 pt-4 pb-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <h2 id="app-guide-title" className="text-lg font-bold text-slate-900 leading-tight">
                {meta.title}
              </h2>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 border-t border-slate-100 bg-slate-50/80 px-4 py-3">
          <button
            ...
            onClick={() => go(page - 1)}
            disabled={isFirst}
            className="inline-flex flex-1 items-center justify-center gap-1 rounded-xl border border-slate-200 bg-white py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-40 disabled:pointer-events-none transition-all"
          >
            <ChevronLeft size={18} />
            Previous
          </button>
