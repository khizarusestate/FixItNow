...
/** Custom pin marker (avoids broken default Leaflet image paths in Vite). */
...
/** Legacy helper — configures divIcon as default for any code still using L.marker(latlng). */
export function configureLeafletIcons() {
  if (configured) return;
  configured = true;
  const pin = createMapMarkerIcon();
